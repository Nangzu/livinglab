...
public class CartService {
    ...
    public CartDTO addToCart(CartDTO cartDTO) {
        ...
        if (cartDTO.getGoodsnum() == null) {
            throw new IllegalArgumentException("GoodsNum is null");
        }
        if (cartDTO.getUsernum() == null) {
            throw new IllegalArgumentException("UserNum is null");
        }
