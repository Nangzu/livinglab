...
public class OrderController {
    ...
    // 주문 생성
    @PostMapping("/create")
    public ResponseEntity<OrderDTO> createOrder(@RequestParam List<Long> cartIds,@RequestBody OrderDTO orderData,
                                                HttpSession session) {
        // 세션에서 사용자 정보 가져오기
        ...
        // 사용자 정보가 있는 경우, 주문 생성
        OrderDTO createdOrder = orderService.createOrder(usernum, cartIds, orderData.getPymethod(), orderData.getState());
